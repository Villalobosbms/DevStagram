        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form>
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" id="email" placeholder="Ingresa tu correo" class="border p-3 w-full rounded-lg">
                </div>
                <div class="mb-5">
                    <label for="password" class="mb-2 block uppercase text-gray-500 font-bold">
                        Password
                    </label>
                    <input type="password" name="password" id="password" placeholder="Ingresa tu contraseña" class="border p-3 w-full rounded-lg">
                </div>
                <div class="mb-5">
